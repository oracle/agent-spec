...
Similar to :ref:`OpenAI Compatible LLMs <openaicompatiblellms_26_1_2>`, you can also configure the ``api_type`` parameter,
...
:ref:`the MCP section <agentspecmcpspec_26_1_2>` below).
...
.. list-table::
    ...
    * - ApiNode
      ...
      - .. list-table::
            ...
            * - api_spec_uri
              ...
              - null
            * - data
              - The data to send to this API call. Behaves the same way as the ``data`` parameter in :ref:`RemoteTool <remotetools_26_1_2>`.
              - any
              - No
              - {}
            * - query_params
    ...
    * - ParallelMapNode
      - The ParallelMapNode is used when we need to map a sequence of nodes to each of the values
        ...
        Please check the concerns regarding parallel execution depicted in the :ref:`parallelization section <parallelization_26_1_2>`.
      - .. list-table::
            :header-rows: 1
            :widths: 20 35 15 15 15
            :class: mywideinnertable
...
For more details on the A2A protocol, refer to the :ref:`A2A (Agent to Agent Protocol) section <agentspeca2aspec_26_1_2>`.
...
:ref:`the sdk detailed below <sdk-agent-spec_26_1_2>`), the abstract interface
...
The disaggregated components references follow the same :ref:`reference system <symbolic_reference_26_1_2>` described for components, based on ID matching.
...
.. _agentspecsensitivefield_26_1_2:
