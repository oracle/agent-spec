...
Use this template to propose a **new feature**, **design change**, or **enhancement** to `Open Agent Spec <#link-to-github>`_.
...
Include links to relevant GitHub issues, external references, documentation, etc.
