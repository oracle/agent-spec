...
from autogen_agentspec_adapter._agentspecconverter import AutogenToAgentSpecConverter
from autogen_core._component_config import Component as AutogenComponent
...
class AgentSpecExporter:
    ...
    def to_yaml(self, autogen_component: AutogenComponent) -> str:  # type: ignore
        ...
        Parameters:
        - autogen_component: AutoGen Component to serialize to an Agent Spec configuration.
    ...
    def to_component(self, autogen_component: AutogenComponent) -> Component:  # type: ignore
        ...
        Parameters:
        - autogen_component: AutoGen Component to transform into a corresponding PyAgentSpec Component.
