...
class _CrewAiEventListener(CrewAIBaseEventListener):
    ...
    def setup_listeners(self, crewai_event_bus: CrewAIEventsBus) -> None:
        ...
        @crewai_event_bus.on(CrewAILiteAgentExecutionStartedEvent)
