...
class AdapterAgnosticAgentSpecLoader(ABC):
    ...
    def load_yaml(
        ...
        >>> runtime_component = loader.load_yaml(main_yaml, components_registry=registry)
    ...
    def load_json(
        ...
        >>> runtime_component = loader.load_json(main_json, components_registry=registry)
    ...
    def load_dict(
        ...
        >>> runtime_component = loader.load_dict(main_dict, components_registry=registry)
