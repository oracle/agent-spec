...
class FlowBuilder:
    ...
    def build_linear_flow(
        ...
        # Auto-wire data flow edges by matching identically named properties only
        # when the caller did not provide explicit data_flow_edges.
        if not data_flow_edges:
            _autowire_linear_data_edges(flow_builder, nodes, inferred_outputs)
