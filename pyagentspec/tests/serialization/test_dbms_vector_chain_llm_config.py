...
def test_dbms_vector_chain_llm_config_serializes() -> None:
    ...
    assert serialized["model_id"] == "gpt-4o"
    ...
    assert serialized["connection_config"] is None
...
def test_dbms_vector_chain_llm_config_round_trips() -> None:
    config = DbmsVectorChainLlmConfig(
        id="database-llm",
        name="database-openai",
        model_id="gpt-4o",
