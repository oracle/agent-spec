...
def test_deserialization_accepts_v26_3_0_configs(simplest_flow: Flow) -> None:
    serialized_flow = AgentSpecSerializer().to_dict(
        simplest_flow, agentspec_version=AgentSpecVersionEnum.v26_3_0
    )

    deserialized_flow = AgentSpecDeserializer().from_dict(serialized_flow)

    assert serialized_flow[AGENTSPEC_VERSION_FIELD_NAME] == AgentSpecVersionEnum.v26_3_0.value
    assert deserialized_flow.min_agentspec_version == AgentSpecVersionEnum.v26_3_0
