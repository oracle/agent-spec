...
def test_current_version_is_26_3_1() -> None:
    assert AgentSpecVersionEnum.current_version == AgentSpecVersionEnum.v26_3_1
    assert AgentSpecVersionEnum.latest_supported_version == AgentSpecVersionEnum.v26_3_1
