...
def test_current_version_is_26_3_0() -> None:
    assert AgentSpecVersionEnum.current_version == AgentSpecVersionEnum.v26_3_0
    assert AgentSpecVersionEnum.latest_supported_version == AgentSpecVersionEnum.v26_3_0
    assert AgentSpecVersionEnum("26.3.0") == AgentSpecVersionEnum.v26_3_0
