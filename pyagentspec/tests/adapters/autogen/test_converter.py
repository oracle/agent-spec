...
def test_autogen_agent_can_be_converted_to_agentspec() -> None:
    ...
    agent = AutogenAssistantAgent(
        ...
        model_client=AutogenOllamaChatCompletionClient(
            model="agi_model",
            ...
            model_info=AutogenModelInfo(
                ...
                json_output=True,
                family=AutogenModelFamily.UNKNOWN,
...
def test_agentspec_agent_can_be_converted_to_autogen() -> None:
    ...
    assert isinstance(autogen_assistant, AutogenAssistantAgent)
    ...
    assert isinstance(autogen_assistant._model_client, AutogenOllamaChatCompletionClient)


def test_tool_descriptions_are_preserved_when_converted_to_autogen() -> None:

    from pyagentspec.adapters.autogen import AgentSpecLoader
    from pyagentspec.adapters.autogen._types import AutogenAssistantAgent
    ...
    # Convert to an AutoGen AutogenAssistantAgent using a callable from the registry for the tool
