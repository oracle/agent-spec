...
def test_build_linear_flow_automatically_infers_inputs_outputs_and_dataflow_edges(
    ...
    # Check that the data connections have been properly inferred
    data_edges = {
        (e.source_node.name, e.destination_node.name, e.source_output, e.destination_input)
        for e in flow.data_flow_connections
    }
    assert data_edges == {
        # Start to nodes
        ("StartNode", "n2", USER_INPUT_NAME, USER_INPUT_NAME),
        ("StartNode", "n3", USER_INPUT_NAME, USER_INPUT_NAME),
        # Between nodes
        ("n1", "n2", N1_OUTPUT_NAME, N1_OUTPUT_NAME),
        ("n1", "n3", N1_OUTPUT_NAME, N1_OUTPUT_NAME),
        # To end nodes
        ("n1", "EndNode_1", N1_OUTPUT_NAME, N1_OUTPUT_NAME),
        ("n2", "EndNode_1", N2_OUTPUT_NAME, N2_OUTPUT_NAME),
        ("n3", "EndNode_1", N3_OUTPUT_NAME, N3_OUTPUT_NAME),
    }
