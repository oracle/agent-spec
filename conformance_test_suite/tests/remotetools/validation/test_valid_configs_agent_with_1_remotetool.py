...
YAML_FILE_NAME = "agent_with_1_remotetool.yaml"
...
def test_valid_configuration_agent_with_1_remotetool_can_be_loaded(
...
def test_valid_configuration_agent_with_1_remotetool_can_be_executed(
    agentspec_component_fixture,
    user_message,
    expected_llm_output,
