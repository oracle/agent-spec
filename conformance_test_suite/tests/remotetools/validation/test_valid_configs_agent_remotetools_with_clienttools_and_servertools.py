...
YAML_FILE_NAME = "agent_remotetools_with_clienttools_and_servertools.yaml"
...
def prompt_to_result_mappings():
    return {
        ...
        "4.0": "4.0",
        "2^3": {"tool_call": {"name": "exponential_tool", "args": {"a": 2, "b": 3}}},
        '{"result":8}': '{"result":8}',
...
def test_valid_configuration_agent_remotetools_with_clienttools_and_servertools_can_be_loaded(
...
def test_valid_configuration_agent_remotetools_with_clienttools_and_servertools_can_execute_clienttools(
    agentspec_component_fixture,
    user_message,
    expected_llm_output,
    tool_name,
...
def test_valid_configuration_agent_remotetools_with_clienttools_and_servertools_can_execute_servertools(
    agentspec_component_fixture,
    user_message,
    expected_llm_output,
    expected_servertool,
...
def test_valid_configuration_agent_remotetools_with_clienttools_and_servertools_can_execute_remotetools(
    agentspec_component_fixture,
    user_message,
    expected_llm_output,
    local_deterministic_llm_server,
