...
YAML_FILE_NAME = "agent_with_1_remotetool_multiple_outputs.yaml"
...
def prompt_to_result_mappings():
    return {
        "3 and 6": {"tool_call": {"name": "sum_multiply_tool", "args": {"a": 3, "b": 6}}},
        '{"sum":9,"product":18}': '{"sum":9,"product":18}',
    }
...
def test_valid_configuration_agent_with_1_remotetool_multiple_outputs_can_be_loaded(
...
def test_valid_configuration_agent_with_1_remotetool_multiple_outputs_can_be_executed(
    agentspec_component_fixture,
    user_message,
    expected_sum,
    expected_product,
