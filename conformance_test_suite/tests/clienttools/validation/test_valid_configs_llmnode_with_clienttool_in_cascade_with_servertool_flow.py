...
YAML_FILE_NAME = "llmnode_with_clienttool_in_cascade_with_servertool_flow.yaml"
...
def test_valid_configs_clienttool_in_cascade_with_servertool_can_be_loaded(
...
def test_valid_configs_clienttool_in_cascade_with_servertool_can_be_executed(
    agentspec_component_fixture, user_input, expected_weather, local_deterministic_llm_server
) -> None:
