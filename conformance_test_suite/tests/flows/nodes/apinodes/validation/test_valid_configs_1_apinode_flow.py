...
YAML_FILE_NAME = "1_apinode_flow.yaml"
...
def test_valid_configs_1_apinode_flow_can_be_loaded(
...
@pytest.mark.parametrize(
    ...
    [
        ("Casablanca", "Sunny", 22.0),
        ("Zurich", "Rainy", 15.0),
    ],
)
def test_valid_configs_1_apinode_flow_can_be_executed(
    agentspec_component_fixture,
    user_input,
    expected_weather,
