...
event-driven **UI interactions** across every surface.

.. seealso::
    :doc:`Agent Spec integrations <integrations>`


.. grid:: 2

    .. grid-item-card:: |agntcy-icon|
        :link: https://schema.oasf.outshift.com/0.8.0/modules/agentspec
        :link-alt: Agent Spec in the AGNTCY/OASF Schema
